document.addEventListener('DOMContentLoaded', async () => {
    if (window.ethereum) {
        ...
        const contractAddress = '0x8890F5d765D87C6b12eA3471E181750Fbab20563'; // Dirección del contrato desplegado
    ...
    // Calcular los dividendos ganados hoy
    const userAccumulatedDividendsToday = userDividendsToday - userTotalDividends;
    ...
    document.getElementById('user-dividends-today').innerText = web3.utils.fromWei(userAccumulatedDividendsToday, 'ether');
